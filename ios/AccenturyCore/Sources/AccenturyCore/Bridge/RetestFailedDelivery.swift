...
///
/// ``itemResultDeliveryJs(_:)``와 같은 모양이고 수신 지점 이름만 다르다 — 이스케이프·반환값
/// 규칙은 ``webDeliveryJs(method:payloadJson:)``에 모여 있다.
///
...
public func retestFailedDeliveryJs(_ failure: RetestFailure) -> String {
