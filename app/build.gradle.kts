...
android {
    ...
    defaultConfig {
        ...
        minSdk = 29
        targetSdk = 36
        // iOS `ios/Accentury/Config/Base.xcconfig`의 CURRENT_PROJECT_VERSION/MARKETING_VERSION과
        // 짝이고, **같은 커밋에서 같이 올린다** (KAN-175 3단계). 한쪽만 올리면
        ...
        // 아이콘으로 업로드됐다(2026-09-23). 다음 업로드는 7부터여야 받아지고, 7이 D3 아이콘을
