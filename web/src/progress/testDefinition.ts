...
export interface GuideF0 {
  ...
  values: (number | null)[]
  /**
   * 허용 밴드 하한. **정본 발행본 `gn-2026.09.1`에는 없다** — KAN-17 산출물의 1안이 중앙선만
   * 내기로 정해지면서(2026-09-04) 발행 검증도 optional로 되돌아갔다(KAN-182, 2026-08-09에
   * required로 확정했던 것을 뒤집은 것이다). 응답이 null 필드를 빼고 직렬화하는 것도 그대로라,
   * 밴드는 앞으로 다시 실릴 수는 있어도 있다고 가정하고 읽으면 안 된다.
   */
  bandLow?: number[]
